    ...
    <div className="dash-root">
      ...
      <details open style={{ marginBottom: 'var(--space-4)' }}>
        <summary style={{ cursor: 'pointer', fontWeight: 600, fontSize: 'var(--text-base)', padding: 'var(--space-3) 0', listStyle: 'none', display: 'flex', alignItems: 'center', gap: 'var(--space-2)' }}>
          ...
          <span style={{ color: 'var(--color-text)' }}>Project Restore Integrity Patch</span>
        ...
        <div style={{ paddingLeft: 'var(--space-4)', paddingTop: 'var(--space-3)', borderLeft: '2px solid var(--color-accent)' }}>
          <p style={{ fontSize: 'var(--text-sm)', color: 'var(--color-text-muted)', marginBottom: 'var(--space-4)' }}>
            Fixes project restoration failing after structured DIBCAC checklist interview notes were successfully read from a backup.
          </p>
          <h3 style={{ fontSize: 'var(--text-sm)', fontWeight: 600, color: 'var(--color-text)', marginBottom: 'var(--space-2)', marginTop: 'var(--space-4)' }}>Backup and Restore</h3>
          <ul style={{ fontSize: 'var(--text-sm)', color: 'var(--color-text-muted)', lineHeight: 'var(--leading-relaxed)', paddingLeft: 'var(--space-5)', marginBottom: 'var(--space-4)' }}>
            <li>Progress reconciliation now safely handles both text fields and structured checklist interview notes.</li>
            <li>Schema v10 groups, folders, Planned Ask references, checklist notes, and progress state restore together.</li>
            <li>Restore errors identify the failing stage and warn if data may already have been partially restored.</li>
            <li>Assessment-workbook preview and merge checks now protect existing structured checklist notes as real objective work.</li>
          </ul>
        </div>
      </details>
      ...
      <details style={{ marginBottom: 'var(--space-4)' }}>
        <summary style={{ cursor: 'pointer', fontWeight: 600, fontSize: 'var(--text-base)', padding: 'var(--space-3) 0', listStyle: 'none', display: 'flex', alignItems: 'center', gap: 'var(--space-2)' }}>
          ...
          <span style={{ color: 'var(--color-text-muted)' }}>—</span>
          <span style={{ color: 'var(--color-text)' }}>Control Status Sync from DIBCAC Mode</span>
          <span style={{ marginLeft: 'auto', fontWeight: 400, fontSize: 'var(--text-sm)', color: 'var(--color-text-muted)' }}>July 19, 2026</span>
        </summary>
        <div style={{ paddingLeft: 'var(--space-4)', paddingTop: 'var(--space-3)', borderLeft: '2px solid var(--color-accent)' }}>

          <p style={{ fontSize: 'var(--text-sm)', color: 'var(--color-text-muted)', marginBottom: 'var(--space-4)' }}>
            Fixes a control's Status not updating when the last remaining objective was marked MET from DIBCAC Mode.
          </p>
          ...
          <ul style={{ fontSize: 'var(--text-sm)', color: 'var(--color-text-muted)', lineHeight: 'var(--leading-relaxed)', paddingLeft: 'var(--space-5)', marginBottom: 'var(--space-4)' }}>
            <li>Marking an objective MET or NOT MET via the checklist toggle or the status-cycle button now recomputes and writes the control's own Status field, same as Control Detail already does — so Control Library and Home immediately reflect a control flipping to MET (or NOT MET) once every objective is resolved, instead of the Status staying stuck at its old value.</li>
          </ul>
      ...
      <details style={{ marginBottom: 'var(--space-4)' }}>
        <summary style={{ cursor: 'pointer', fontWeight: 600, fontSize: 'var(--text-base)', padding: 'var(--space-3) 0', listStyle: 'none', display: 'flex', alignItems: 'center', gap: 'var(--space-2)' }}>
          <span style={{ fontFamily: 'var(--font-mono)', color: 'var(--color-accent)' }}>v4.8.3</span>
          <span style={{ color: 'var(--color-text-muted)' }}>—</span>
          <span style={{ color: 'var(--color-text)' }}>Persistent Review Group State</span>
          <span style={{ marginLeft: 'auto', fontWeight: 400, fontSize: 'var(--text-sm)', color: 'var(--color-text-muted)' }}>July 19, 2026</span>
        </summary>
        <div style={{ paddingLeft: 'var(--space-4)', paddingTop: 'var(--space-3)', borderLeft: '2px solid var(--color-accent)' }}>

          <p style={{ fontSize: 'var(--text-sm)', color: 'var(--color-text-muted)', marginBottom: 'var(--space-4)' }}>
            A small patch fixing DIBCAC Mode state that was being lost on navigation.
          </p>

          <h3 style={{ fontSize: 'var(--text-sm)', fontWeight: 600, color: 'var(--color-text)', marginBottom: 'var(--space-2)', marginTop: 'var(--space-4)' }}>DIBCAC Mode</h3>
          <ul style={{ fontSize: 'var(--text-sm)', color: 'var(--color-text-muted)', lineHeight: 'var(--leading-relaxed)', paddingLeft: 'var(--space-5)', marginBottom: 'var(--space-4)' }}>
            <li>Fixed expanded review groups, open folders, and the Review Groups full-width toggle collapsing whenever you navigated to another page and back — this state now persists across navigation instead of resetting on every visit to DIBCAC Mode.</li>
          </ul>
      ...
      <details style={{ marginBottom: 'var(--space-4)' }}>
        <summary style={{ cursor: 'pointer', fontWeight: 600, fontSize: 'var(--text-base)', padding: 'var(--space-3) 0', listStyle: 'none', display: 'flex', alignItems: 'center', gap: 'var(--space-2)' }}>
          <span style={{ fontFamily: 'var(--font-mono)', color: 'var(--color-accent)' }}>v4.8.2</span>
          <span style={{ color: 'var(--color-text-muted)' }}>—</span>
          <span style={{ color: 'var(--color-text)' }}>Template Character Limits</span>
          <span style={{ marginLeft: 'auto', fontWeight: 400, fontSize: 'var(--text-sm)', color: 'var(--color-text-muted)' }}>July 19, 2026</span>
        </summary>
        <div style={{ paddingLeft: 'var(--space-4)', paddingTop: 'var(--space-3)', borderLeft: '2px solid var(--color-accent)' }}>

          <p style={{ fontSize: 'var(--text-sm)', color: 'var(--color-text-muted)', marginBottom: 'var(--space-4)' }}>
            Aligns free-text character limits with the official CMMC Assessment Template Data Element Glossary.
          </p>

          <h3 style={{ fontSize: 'var(--text-sm)', fontWeight: 600, color: 'var(--color-text)', marginBottom: 'var(--space-2)', marginTop: 'var(--space-4)' }}>Control Detail</h3>
          <ul style={{ fontSize: 'var(--text-sm)', color: 'var(--color-text-muted)', lineHeight: 'var(--leading-relaxed)', paddingLeft: 'var(--space-5)', marginBottom: 'var(--space-4)' }}>
            <li>Interviews, Examine, and Test were previously capped at 400 characters (an outdated eMASS limit) — all four are now capped at 4000 to match the template glossary, including Overall Comments, which previously had no limit or counter at all.</li>
            <li>Each field now has a hard character cap on the textarea itself, in addition to the live counter.</li>
          </ul>
          ...
          <ul style={{ fontSize: 'var(--text-sm)', color: 'var(--color-text-muted)', lineHeight: 'var(--leading-relaxed)', paddingLeft: 'var(--space-5)', marginBottom: 'var(--space-4)' }}>
            <li>Added defensive truncation so an exported cell can never exceed the template's limits: Artifacts (400 per value, 4000 combined per objective), Interviews/Examine/Test/Overall Comments/Findings (4000), Provider Dependency ESP Name (2000), and Assessed By (100).</li>
          </ul>
